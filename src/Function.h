...
namespace dd
{
	...
	{
		ret->Access<R>() = (*FunctionPtr)(GetArg<Index, Args...>::get(args)...);
	}
	...
	{
		ret->Set((context->*FunctionPtr)(GetArg<Index, Args...>::get(args)...));
	}
